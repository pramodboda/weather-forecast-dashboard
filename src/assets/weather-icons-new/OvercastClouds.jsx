...
//	Clouds overcast clouds/ overcast -  Day and Night : 85-100%
// code: 804
function OvercastClouds(props) {
  return (
    <svg
  ...
  >
    <defs>
      <symbol id="OvercastClouds-c" viewBox="0 0 200.3 126.1">
        <path
          fill="url(#OvercastClouds-a)"
          stroke="#848b98"
          strokeMiterlimit={10}
      ...
      <symbol id="OvercastClouds-d" viewBox="0 0 350 222">
        <path
          fill="url(#OvercastClouds-b)"
          stroke="#e6effc"
          strokeMiterlimit={10}
          strokeWidth={6}
      ...
      <symbol id="OvercastClouds-e" overflow="visible" viewBox="0 0 398 222">
        <use
          xlinkHref="#OvercastClouds-c"
          width={200.3}
          height={126.1}
        ...
        <use xlinkHref="#OvercastClouds-d" width={350} height={222}>
          <animateTransform
            additive="sum"
            attributeName="transform"
            dur="6s"
