...
function OvercastDayDrizzleSVGIcon(props) {
  ...
  >
    <defs>
      ...
      <symbol id="e" viewBox="0 0 200.3 126.1">
        <path
          fill="url(#c)"
          stroke="#848b98"
          strokeMiterlimit={10}
      ...
      <symbol id="h" overflow="visible" viewBox="0 0 398 222">
        ...
        <use xlinkHref="#f" width={350} height={222}>
          <animateTransform
            additive="sum"
            attributeName="transform"
            dur="6s"
      ...
      <symbol id="i" overflow="visible" viewBox="0 0 410.8 258">
        <use xlinkHref="#g" width={196} height={196} />
        <use
          xlinkHref="#h"
          width={398}
          height={222}
