...
function SunsetSVGIcon(props) {
  ...
  >
    <defs>
      ...
      <clipPath id="SunsetSVGIcon-b">
        <path
          fill="none"
          d="M512 306H296a21.5 21.5 0 00-14 5.3L256 334l-26-22.7a21.5 21.5 0 00-14-5.3H0V0h512Z"
        />
      </clipPath>
      <symbol id="SunsetSVGIcon-c" viewBox="0 0 384 384">
        <circle
          cx={192}
          cy={192}
          r={84}
          fill="url(#SunsetSVGIcon-a)"
          stroke="#f8af18"
          strokeMiterlimit={10}
          strokeWidth={6}
        />
    ...
    <g clipPath="url(#SunsetSVGIcon-b)">
      <use
        xlinkHref="#SunsetSVGIcon-c"
        width={384}
        height={384}
